...
public class AddResrvationExcursion extends Form  {
    ...
    public AddResrvationExcursion(Form previous,Entity.Excursion1 e) {
     ...
     setTitle("Add ResrvationVoyage");
        ...
        TextField Date_Reservation_Excursion = new TextField("", "Date_Reservation_Excursion");
                 Date_Reservation_Excursion.getStyle().setFgColor(154245);
        ...
        previous.showBack();
          ...
          addAll(Date_Reservation_Excursion,Nbr_Personne,Age,btnValider);
    }  
