     ...
     FileChooser.showOpenDialog(multiSelect.isSelected(),".jpg,.jpeg,.png/plain",(ActionEvent e2)->{
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {
                    try {
                        Voyage Voyage = new Voyage(Integer.parseInt(Prix.getText()),Destination.getText(),Nom_Voyage.getText(),Duree_Voyage.getText(),"Non",photoButton.getBadgeText().toString());
        ...
        previous.showBack();
          ...
          addAll(Destination,Nom_Voyage,Duree_Voyage,Prix,photoButton,btnValider);
    }  
