 ...
 * @author ASUS
 */
public class AddRestaurant extends Form {

    public AddRestaurant(Form previous) {
     ...
     FileChooser.showOpenDialog(multiSelect.isSelected(),".jpg,.jpeg,.png/plain",(ActionEvent e2)->{
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {
                    try {
                        Restaurant res = new Restaurant(Integer.parseInt(Num_Tel_Restaurant.getText()),Nom_Restaurant.getText(),Adresse_Restaurant.getText(),photoButton.getBadgeText().toString(),Description_Restaurant.getText());
